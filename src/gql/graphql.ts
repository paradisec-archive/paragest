...
export type Essence = {
  __typename?: 'Essence';
  bitrate?: Maybe<Scalars['BigInt']['output']>;
...
export type EssenceAttributes = {
  bitrate?: InputMaybe<Scalars['BigInt']['input']>;
...
export type ItemBwfCsv = {
  __typename?: 'ItemBwfCsv';
...
export type Mutation = {
  ...
  setCollectionHasDepositForm?: Maybe<SetCollectionHasDepositFormPayload>;
};
...
export type MutationSetCollectionHasDepositFormArgs = {
...
export type SetCollectionHasDepositFormPayload = {
  __typename?: 'SetCollectionHasDepositFormPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};
